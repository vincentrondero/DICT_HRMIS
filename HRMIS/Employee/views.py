...
def employee_dashboard(request, user_role):
    ...
    return render(request, 'Employee/Employee.html', {'user_name': user_name, 'user_role': user_role, 'user': user, 'user_profile': user_profile, 'user_payslips': user_payslips, 'all_attendances':all_attendances})
